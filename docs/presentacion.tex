...
Usando enfoque acumulativo en MiniZinc:
\begin{itemize}
    \item Array acumulativo de personas por opinión
    \item Buscar posición donde se alcanza $\lfloor n/2 \rfloor + 1$
    \item Si $n$ par: promedio de dos valores centrales
\end{itemize}
\end{block}
\end{frame}
